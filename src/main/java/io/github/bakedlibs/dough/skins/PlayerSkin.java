...
public final class PlayerSkin {
    ...
    PlayerSkin(@Nonnull UUID uuid, @Nullable String base64skinTexture, @Nonnull String customName) {
        this.profile = new CustomGameProfile(uuid, base64skinTexture, customName);
    }
