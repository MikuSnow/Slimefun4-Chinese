...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack PORTABLE_DUSTBIN = new SlimefunItemStack(
            "PORTABLE_DUSTBIN", Material.STICK, "&6便携垃圾箱", "&r轻松的消除多余的物品", "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    public static final SlimefunItemStack ENDER_BACKPACK = new SlimefunItemStack(
            "ENDER_BACKPACK", Material.STICK, "&6末影背包", "&a&o便携式末影箱", "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack BROKEN_SPAWNER = new SlimefunItemStack(
            "BROKEN_SPAWNER", HeadTexture.MISSING_TEXTURE, "&c已损坏的刷怪笼", "&7类型: &b<类型>", "", "&c已损坏, 需要在古代祭坛中修复");
    ...
    public static final SlimefunItemStack GRANDMAS_WALKING_STICK =
            new SlimefunItemStack("GRANDMAS_WALKING_STICK", Material.STICK, "&7阿婆的拐杖");
    ...
    public static final SlimefunItemStack COMPRESSED_CARBON =
            new SlimefunItemStack("COMPRESSED_CARBON", Material.COAL, "&c压缩碳");
    public static final SlimefunItemStack CARBON_CHUNK =
            new SlimefunItemStack("CARBON_CHUNK", Material.COAL, "&4碳块");
    ...
    public static final SlimefunItemStack POWER_CRYSTAL =
            new SlimefunItemStack("POWER_CRYSTAL", Material.AMETHYST_SHARD, "&c&l能量水晶");
    ...
    public static final SlimefunItemStack STONE_CHUNK =
            new SlimefunItemStack("STONE_CHUNK", Material.STICK, "&6石块");
    public static final SlimefunItemStack LAVA_CRYSTAL =
            new SlimefunItemStack("LAVA_CRYSTAL", Material.STICK, "&4岩浆水晶");
    ...
    public static final SlimefunItemStack DUCT_TAPE =
            new SlimefunItemStack("DUCT_TAPE", Material.KELP, "&8强力胶布", "", "&r可以用这个在自动铁砧里", "&r修复物品");
    ...
    public static final SlimefunItemStack TINY_URANIUM = new SlimefunItemStack(
            "TINY_URANIUM", Material.STICK, "&c一小撮U238", "", LoreBuilder.radioactive(Radioactivity.LOW));
    ...
    public static final SlimefunItemStack NECROTIC_SKULL =
            new SlimefunItemStack("NECROTIC_SKULL", Material.STICK, "&c坏死颅骨");
    ...
    public static final SlimefunItemStack ELECTRO_MAGNET =
            new SlimefunItemStack("ELECTRO_MAGNET", Material.STICK, "&c电磁铁");
    public static final SlimefunItemStack HEATING_COIL =
            new SlimefunItemStack("HEATING_COIL", Material.STICK, "&c加热线圈");
    ...
    public static final SlimefunItemStack ELECTRIC_MOTOR =
            new SlimefunItemStack("ELECTRIC_MOTOR", Material.STICK, "&c电动马达");
    public static final SlimefunItemStack CARGO_MOTOR =
            new SlimefunItemStack("CARGO_MOTOR", Material.STICK, "&3货运马达", "", "&7货运网络相关机器重要的零件");
    ...
    public static final SlimefunItemStack HARDENED_GLASS =
            new SlimefunItemStack("HARDENED_GLASS", HeadTexture.MISSING_TEXTURE, "&7钢化玻璃", "", "&r可以抵抗爆炸");
    public static final SlimefunItemStack WITHER_PROOF_OBSIDIAN =
            new SlimefunItemStack("WITHER_PROOF_OBSIDIAN", HeadTexture.MISSING_TEXTURE, "&5防凋灵黑曜石", "", "&r可以抵抗爆炸和", "&r凋灵的攻击");
    public static final SlimefunItemStack WITHER_PROOF_GLASS = new SlimefunItemStack(
            "WITHER_PROOF_GLASS", HeadTexture.MISSING_TEXTURE, "&5防凋灵玻璃", "", "&r可以抵抗爆炸和", "&r凋灵的攻击");
    ...
    public static final SlimefunItemStack CRAFTING_MOTOR =
            new SlimefunItemStack("CRAFTING_MOTOR", Material.STICK, "&6合成机马达", "", "&7自动合成机重要的零件");
    ...
    public static final SlimefunItemStack GOLD_24K_BLOCK =
            new SlimefunItemStack("GOLD_24K_BLOCK", HeadTexture.MISSING_TEXTURE, "&r&r金块 &7(24克拉)");
    ...
    public static final SlimefunItemStack SYNTHETIC_SAPPHIRE =
            new SlimefunItemStack("SYNTHETIC_SAPPHIRE", Material.DIAMOND, "&b人造蓝宝石", "", "&r可以在工作台中作为青金石使用");
    public static final SlimefunItemStack CARBONADO =
            new SlimefunItemStack("CARBONADO", Material.COAL, "&b&l黑金刚石", "", "&7&o\"黑色钻石\"");
    public static final SlimefunItemStack RAW_CARBONADO =
            new SlimefunItemStack("RAW_CARBONADO", Material.COAL, "&b黑金刚石原矿");

    public static final SlimefunItemStack URANIUM = new SlimefunItemStack(
            "URANIUM",
            Material.STICK, "&4U238",
            "",
    ...
    public static final SlimefunItemStack HOLOGRAM_PROJECTOR =
            new SlimefunItemStack("HOLOGRAM_PROJECTOR", HeadTexture.MISSING_TEXTURE, "&b全息投影仪", "", "&r投影出可编辑的全息文字");
    ...
    public static final SlimefunItemStack BOOK_BINDER = new SlimefunItemStack(
            ...
            "&6附魔书整合机",
            "",
            "&f将多个附魔书全部绑定到一本上.", "", LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), LoreBuilder.powerPerSecond(16));
    public static final SlimefunItemStack BIO_REACTOR = new SlimefunItemStack("BIO_REACTOR", HeadTexture.MISSING_TEXTURE,
            "&2生物发电机",
            "",
            LoreBuilder.machine(MachineTier.AVERAGE, MachineType.GENERATOR),
            "&8\u21E8 &e\u26A1 &7128 J 可储存",
    ...
    public static final SlimefunItemStack OIL_BUCKET =
            new SlimefunItemStack("BUCKET_OF_OIL", Material.STICK, "&r原油桶");
    public static final SlimefunItemStack FUEL_BUCKET =
            new SlimefunItemStack("BUCKET_OF_FUEL", Material.STICK, "&r燃料桶");

    public static final SlimefunItemStack REFINERY =
            new SlimefunItemStack("REFINERY", HeadTexture.MISSING_TEXTURE, "&c炼油机", "", "&r将原油提炼为燃油");
    ...
    public static final SlimefunItemStack ANDROID_MEMORY_CORE =
            new SlimefunItemStack("ANDROID_MEMORY_CORE", Material.STICK, "&b机器人内存核心");

    public static final SlimefunItemStack GPS_TELEPORTER_PYLON =
            new SlimefunItemStack("GPS_TELEPORTER_PYLON", HeadTexture.MISSING_TEXTURE, "&5GPS 信号塔", "", "&7传送器组件");
    ...
    public static final SlimefunItemStack NETHER_ICE_COOLANT_CELL =
            new SlimefunItemStack("NETHER_ICE_COOLANT_CELL", Material.STICK, "&6下界冰冷却剂");
    ...
    public static final SlimefunItemStack ORGANIC_FOOD =
            new SlimefunItemStack("ORGANIC_FOOD", Material.STICK, "&a有机食物", "&7内含 &9???");
    public static final SlimefunItemStack WHEAT_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_WHEAT", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9小麦");
    public static final SlimefunItemStack CARROT_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_CARROT", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9胡萝卜");
    public static final SlimefunItemStack POTATO_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_POTATO", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9土豆");
    public static final SlimefunItemStack SEEDS_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_SEEDS", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9小麦种子");
    public static final SlimefunItemStack BEETROOT_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_BEETROOT", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9甜菜");
    public static final SlimefunItemStack MELON_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_MELON", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9西瓜");
    public static final SlimefunItemStack APPLE_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_APPLE", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9苹果");
    public static final SlimefunItemStack SWEET_BERRIES_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_SWEET_BERRIES", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9浆果");
    public static final SlimefunItemStack KELP_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_KELP", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9干海带");
    public static final SlimefunItemStack COCOA_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_COCOA", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含 &9可可豆");
    public static final SlimefunItemStack SEAGRASS_ORGANIC_FOOD = new SlimefunItemStack(
            "ORGANIC_FOOD_SEAGRASS", Material.STICK, ORGANIC_FOOD.getDisplayName(), "&7内含: &9海草");

    public static final SlimefunItemStack FERTILIZER =
            new SlimefunItemStack("FERTILIZER", Material.STICK, "&a有机肥料", "&7内含 &9???");
    public static final SlimefunItemStack WHEAT_FERTILIZER =
            new SlimefunItemStack("FERTILIZER_WHEAT", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9小麦");
    public static final SlimefunItemStack CARROT_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_CARROT", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9胡萝卜");
    public static final SlimefunItemStack POTATO_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_POTATO", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9土豆");
    public static final SlimefunItemStack SEEDS_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_SEEDS", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9小麦种子");
    public static final SlimefunItemStack BEETROOT_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_BEETROOT", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9甜菜");
    public static final SlimefunItemStack MELON_FERTILIZER =
            new SlimefunItemStack("FERTILIZER_MELON", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9西瓜");
    public static final SlimefunItemStack APPLE_FERTILIZER =
            new SlimefunItemStack("FERTILIZER_APPLE", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9苹果");
    public static final SlimefunItemStack SWEET_BERRIES_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_SWEET_BERRIES", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9浆果");
    public static final SlimefunItemStack KELP_FERTILIZER =
            new SlimefunItemStack("FERTILIZER_KELP", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9干海带");
    public static final SlimefunItemStack COCOA_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_COCOA", Material.STICK, FERTILIZER.getDisplayName(), "&7内含 &9可可豆");
    public static final SlimefunItemStack SEAGRASS_FERTILIZER = new SlimefunItemStack(
            "FERTILIZER_SEAGRASS", Material.STICK, FERTILIZER.getDisplayName(), "&7内含: &9海草");
    ...
    public static final SlimefunItemStack REACTOR_COOLANT_CELL =
            new SlimefunItemStack("REACTOR_COLLANT_CELL", Material.STICK, "&b反应堆冷却剂");
    ...
    public static final SlimefunItemStack CRAFTER_SMART_PORT = new SlimefunItemStack(
            "CRAFTER_SMART_PORT", HeadTexture.MISSING_TEXTURE, "&a合成机智能交互接口", "", "&5可以根据合成表材料数量分配输入数量", "&5并拥有指定输出槽");
